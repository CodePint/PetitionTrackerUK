...
Revision ID: 929415eecbb0
Revises: 
Create Date: 2020-06-21 17:54:06.562762
...
def upgrade():
    ...
    sa.Column('state', sqlalchemy_utils.types.choice.ChoiceType([('O', 'Open'), ('C', 'Closed'), ('R', 'Rejected')]), nullable=False),
