...
Revision ID: 20045bcb6b8c
Revises: 
Create Date: 2020-06-19 16:49:13.705560
...
def upgrade():
    ...
    sa.Column('state', sqlalchemy_utils.types.choice.ChoiceType([(0, 'Open'), (1, 'Closed'), (2, 'Rejected')]), nullable=False),
    ...
    op.create_table('total_signatures',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('Record.records', sa.Integer(), nullable=True),
    sa.Column('count', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['Record.records'], ['record.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('total_signatures')
