...
Revision ID: 816f14e9fb6f
Revises: 
Create Date: 2020-06-24 16:24:20.261649
...
def upgrade():
    ...
    sa.Column('state', sqlalchemy_utils.types.choice.ChoiceType([('C', 'Closed'), ('R', 'Rejected'), ('O', 'Open'), ('D', 'Debated'), ('ND', 'Not Debated'), ('AW', 'Awaiting Response'), ('WR', 'With Response'), ('AW', 'Awaiting Debate')]), nullable=False),
